...
if __name__ == '__main__':
    original_str = '{}-{}'.format(99999999, int(time.time()))
    pwd = 'pig'
    ...
    print('Original String: ', original_str.encode('utf-8'))
    enc_str = cryptor.encrypt_str(original_str)
    print("Encrypted String: ", enc_str, len(enc_str))
    dec_str = cryptor.decrypt_str(enc_str)
    print("Decrypted String: ", dec_str)
    assert dec_str == original_str
